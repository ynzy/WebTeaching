		...
		(T.prototype.calendar = function (e) {
			...
			if (
				...
				u &&
					(s.range &&
						(e
							? (r.endDate = r.endDate || { year: l.year + ('year' === s.type ? 1 : 0), month: l.month + ('month' === s.type ? 0 : -1) })
						...
						.each(function (e, a) {
							w(a)
								...
								.each(function (a, i) {
									n.limit(
										w(i),
										[{ hours: a }, { hours: n[x].hours, minutes: a }, { hours: n[x].hours, minutes: n[x].minutes, seconds: a }][e],
										t,
